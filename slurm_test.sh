...
export PROJ_DIR=/export/home/bio_class/jdwest3771
cd $PROJ_DIR
...
/export/share/software/biological/bowtie2-2.4.2-sra-linux-x86_64/bowtie2 -x \
		genome/Thermus_thermophilus_TTHNAR1 \
        -1 fastq/${SRR}_pass_1.fastq \
        -2 fastq/${SRR}_pass_2.fastq --sensitive-local \
        --rg-id ${SRR} --rg -S SM:${SRR} --rg PL:ILLUMINA \
        > alignment/${SRR}.sam 
